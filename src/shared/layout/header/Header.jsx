...
import Menu from "@/shared/layout/header/menu/Menu";
import {menuItem, menuItem2} from "@/utils/DataMenu";
import {IoSearchOutline} from "react-icons/io5";
import {RiShoppingCart2Line} from "react-icons/ri";
import {FaRegUser} from "react-icons/fa";
import {IoMenuOutline} from "react-icons/io5";
import MenuMobile from "@/shared/layout/header/menu/MenuMobile";
import {AnimatePresence} from "framer-motion";
import PopupItems from "@/shared/layout/header/popItem/PopupItems";
import PopupSearch from "@/shared/layout/header/popItem/PopupSearch";
...
function Header(props) {
            ...
            <header className="hidden bg-white w-full h-[100px] px-8 shadow-md  md:flex items-center justify-around">
                ...
                <div className="flex items-center justify-between">
                    <li className="ml-5 group">
                        <Link href="@/shared/layout/header/Header" className="
    ...
    "
      ...
      "
                    ...
                    <Menu setPopItem={setPopItem} label="شعبه" link="/substation" children={menuItem} mr="ml-5"/>
                    <Menu label="منو" children={menuItem2} link="/substation"/>
      ...
      "
            ...
            <header className="flex items-center justify-between md:hidden px-8 py-5 shadow-md">
                <div onClick={() => setShowMenu(!showMenu)} className="text-[#417F56] cursor-pointer"><IoMenuOutline
                    size={24}/></div>
                <div>
                    <Link href="@/shared/layout/header/Header">
                        <Image
                            src="/image/Logo.svg"
                            alt="Logo"
                            width={102}
