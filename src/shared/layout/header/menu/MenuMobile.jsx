                    ...
                    <div
                        ...
                        <div className="px-5 divide-y divide-[#eeeeee]">
                            <div className="flex items-center justify-start mt-5  text-black hover:text-[#417F56]">
                                <RiHome2Line/>
                                <Link className="text-[12px] mr-2" href="/PROGRMMING/NEXT/foodproject/public">صفحه اصلی</Link>
                            </div>
                            <div onClick={() => setShowMenuMobile(!showMenuMobile)}
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center ">
                                        <IoIosMenu/>
                                        <Link className="mr-2" href="@/shared/layout/header/menu/MenuMobile"> منو</Link>
                                    </div>
                                    <IoIosArrowDown/>
                                </div>
                                <AnimatePresence>
                            ...
                            <div className="flex items-center justify-start mt-5 pt-2 text-black hover:text-[#417F56]">
                                <FaUsers/>
                                <Link className="text-[12px] mr-2" href="/PROGRMMING/NEXT/foodproject/public">درباره ما</Link>
                            </div>
                            <div className="flex items-center justify-start mt-5 pt-2 text-black hover:text-[#417F56]">
                                <IoCallOutline/>
                                <Link className="text-[12px] mr-2" href="/PROGRMMING/NEXT/foodproject/public">تماس با ما</Link>
                            </div>
                        </div>
                    </div>
                </div>
