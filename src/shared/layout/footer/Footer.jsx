            ...
            <div className="relative z-10 flex justify-around pt-20 items-start  w-full md:grid  md:grid-cols-4 gap-8  md:px-32 md:py-10 text-white">
                ...
                <div className="flex flex-col  ">
                    ...
                    <ul className="space-y-3 text-[14px]">
                        <li className=""><Link href="@/shared/layout/footer/Footer">پرسش‌های متداول</Link></li>
                        <li><Link href="@/shared/layout/footer/Footer">قوانین ترخینه</Link></li>
                        <li><Link href="@/shared/layout/footer/Footer">حریم خصوصی</Link></li>
                        <li className="flex space-x-3 mt-2">
                            <Link className="text-xl md:text-sm ml-2" href="@/shared/layout/footer/Footer"><CiTwitter/></Link>
                            <Link className="text-xl md:text-sm mr-2" href="@/shared/layout/footer/Footer"><CiInstagram/></Link>
                            <Link className="text-xl md:text-sm " href="@/shared/layout/footer/Footer"><FaTelegramPlane/></Link>
                        </li>
                    </ul>
                </div>
                ...
                <div className="flex flex-col  ">
                    ...
                    <ul className="space-y-3 text-[14px]">
                        <li><Link href="@/shared/layout/footer/Footer">شعبه اکباتان</Link></li>
                        <li><Link href="@/shared/layout/footer/Footer">شعبه چالوس</Link></li>
                        <li><Link href="@/shared/layout/footer/Footer">شعبه اقدسیه</Link></li>
                        <li><Link href="@/shared/layout/footer/Footer">شعبه ونک</Link></li>
                    </ul>
                </div>
